...
output_columns = [
    "수험번호", "이름",  # 기본
    "생년월일6자리_등본", "등본_확인번호", "등본_발급날짜",  # 등본
    "초본_확인인번호", "초본_발급날짜","생년월일6자리_초본", # 초본
    "건강보험자격득실_확인번호_건보", "건강보험자격득실_확인번호_정부24",  # 건강보험자격득실
    "국민연금가입자증명_확인번호_국민연금","국민연금가입자증명_확인인번호_정부24",  # 국민연금가입자증명
    "토익_수험번호", "토익_발급번호",   # 토익
    "토스_수험번호", "토스_발급번호",   # 토스
    "성적증명_대학교","성적증명_문서확인번호", "성적증명_추정발급일",  # 성적증명서
    "졸업증명_대학교","졸업증명_확인번호","졸업증명_추정발급일"  # 졸업증명서
]
