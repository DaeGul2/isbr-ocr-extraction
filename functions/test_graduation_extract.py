...
uni_file_path = "./university_list.xlsx"
...
# ✅ 졸업증명서 문서확인번호 추출 함수
def extract_info_from_graduation(name, text):
    """
...
# output_columns = ["파일명", "졸업증명_문서확인번호", "졸업증명_추정발급일","졸업증명_대학교"]
...
#         "졸업증명_대학교": [", ".join(extracted_data["졸업증명_대학교"]) if extracted_data["졸업증명_대학교"] else ""],
#     })
